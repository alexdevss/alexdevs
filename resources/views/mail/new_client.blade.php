<div style="margin: 0 20px">
    <div style="background-color:#ffcc66;text-align:center;padding:30px 0">
        <h1 style="color: #fff;">¡Hola titán!</h1>
        <h3 style="color: #fff;">Tienes un nuevo cliente y sus datos son:</h3>
        <p style="color:#fff">Nombre: {{$name}} {{$last_names}}</p>
        <p style="color:#fff">Correo electrónico: {{$email}}</p>
