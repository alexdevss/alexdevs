...
<div>
    <div class="container">
        <div class="white-box shadow-lg p-4 ">
                ...
                <div class="row">
                    <div class="col-lg-7 col-12">
                        <div class="form-group">
                            ...
                            <input type="name" class="form-control rounded" id="name" placeholder="Ej: Peter">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-lg-5 col-12">
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            <a href="#" class="button rounded-pill px-5 py-1 mt-4 animation">
                                Enviar
                            </a>
                        </div>
                    </div>
