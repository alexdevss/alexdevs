...
@section('title', "Cookies | alexdevs")
@section('view', 'cookies')
@section('main')
...
<div class="container">
    <div class="white-box p-5 shadow-lg">
        ...
        <h4>Según su funcionalidad</h4>
        <ul>
            <li>Cookies necesarias: son aquellas imprescindibles para el correcto funcionamiento del sitio web. No recopilan ningún tipo de datos de usuario y recogen información como la preferencia de idioma, si se ha aceptado la política de cookies, etc.</li>
        ...
        <ul>
            ...
            <li>Internet Explorer: https://support.microsoft.com/es-es/help/17442/windows-internet-explorer-delete-manage-cookies</li>
